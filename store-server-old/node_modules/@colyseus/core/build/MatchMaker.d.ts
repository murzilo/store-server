import { type Type, Deferred, type ExtractMethodOrPropertyType } from '@colyseus/core/utils/Utils';
import { RegisteredHandler } from '@colyseus/core/matchmaker/RegisteredHandler';
import { type OnCreateOptions, Room } from '@colyseus/core/Room';
import { type Presence } from '@colyseus/core/presence/Presence';
import { type IRoomCache, type MatchMakerDriver, type SortOptions } from '@colyseus/core/matchmaker/LocalDriver/LocalDriver';
import { controller } from '@colyseus/core/matchmaker/controller';
import * as stats from '@colyseus/core/Stats';
import type { AuthContext } from '@colyseus/core/Transport';
import { type ExtractRoomCacheMetadata } from '@colyseus/core/matchmaker/driver';
 ...
 */
export declare function getLocalRoomById(roomId: string): Room<import("@colyseus/core/Room").RoomOptions>;
/**
