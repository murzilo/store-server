...
import { type OAuthProviderCallback } from '@colyseus/auth/oauth';
import { type JwtPayload } from '@colyseus/auth/JWT';
...
export declare const auth: {
    ...
    oauth: {
        ...
        prefix: string;
        providers: { [providerId in import("@colyseus/auth/oauth").OAuthProviderName]: import("@colyseus/auth/oauth").OAuthProviderConfig; };
        addProvider: (providerId: import("@colyseus/auth/oauth").OAuthProviderName, config: import("@colyseus/auth/oauth").OAuthProviderConfig) => void;
     ...
     */
    middleware: <T = JwtPayload>(options?: import("jsonwebtoken").VerifyOptions) => import("@colyseus/auth/JWT").JWTAuthMiddleware<T>;
